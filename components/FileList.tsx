...
import FolderNavigation from "@/components/FolderNav";
...
export default function FileList({
  ...
  const fetchFiles = async () => {
    ...
    try {
      ...
      console.log("API response data is thisssssssssssssssssss:", response.data);

      // The API returns an object shaped like { files: [...] }.
      // Accept both shapes: either an array at the root or an object with a `files` array.
      const responseData = response.data;
      const filesArray = Array.isArray(responseData)
        ? responseData
